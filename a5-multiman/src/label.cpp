...
SlideBar::SlideBar(){
	...
	mom_count = 0;	
	pos = vec3f(0,0,0);
	texture_ref texture = find_texture("slidebar");
...
void SlideBar::setup_display(){
	initialize_gui_overlay();
}


void SlideBar::initialize_gui_overlay(){
...
void SlideBar::render_gui_overlay(){
